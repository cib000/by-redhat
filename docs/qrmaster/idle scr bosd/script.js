...
0x0000000A 	This BSOD means that Microsoft Windows or a kernel-mode driver accessed paged memory at DISPATCH_LEVEL or above. BSOD error code 

0x0000000A  may also show "IRQL_NOT_LESS_OR_EQUAL" on the same blue screen.
...
0x00000021 	This BSOD means that quota charges have been mishandled by returning more quota to a particular block than was previously charged. 
BSOD error code 0x00000021 may also show "QUOTA_UNDERFLOW" on the same blue screen.
...
0x0000003E 	This BSOD means that the system has multiple processors, but they are asymmetric in relation to one another. BSOD error code 

0x0000003E may also show "MULTIPROCESSOR_CONFIGURATION_NOT_SUPPORTED" on the same blue screen.
...
0x00000044 	This BSOD means that a driver has tried to requested an IRP be completed that is already complete. BSOD error code 0x00000044 may 
also show "MULTIPLE_IRP_COMPLETE_REQUESTS" on the same blue screen.
...
0x0000004E 	This BSOD means that the page frame number (PFN) list is corrupted. BSOD error code 0x0000004E may also show "PFN_LIST_CORRUPT" on 
...
0x00000067 	This BSOD means that the registry configuration failed. BSOD error code 0x00000067 may also show "CONFIG_INITIALIZATION_FAILED" on 
the same blue screen.
...
0x0000009A 	This BSOD means that the software license agreement has been violated. BSOD error code 0x0000009A may also show 
"SYSTEM_LICENSE_VIOLATION" on the same blue screen.
