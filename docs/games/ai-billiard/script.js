...
class Player {
  ...
  get nameText() {
    if (this.number === 1) return '<strong>나</strong>';
    return '<strong>에이아이(AI)</strong>';
  }
  ...
  get winText() {
    if (this.number === 1) return '<strong>나</strong> 승리!';
    return '<strong>에이아이(AI)</strong> 승리!';
  }
